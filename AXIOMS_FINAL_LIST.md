...
The current `pnp3/` proof development depends on four externally justified
...
| Part C — Anti-checker lower bounds | `LowerBounds/AntiChecker.lean` | 2 | Lipton–Young (1994), Chapman–Williams (2015), OPS (2019/2021) |
...
### Part C — Anti-Checker Lower Bounds (2 axioms)
...
4. **`antiChecker_exists_large_Y_local`** — local solver version.
   - Sources for 3–4: Lipton–Young (1994), Chapman–Williams (2015),
...
- **2025-12-18** — Proved `antiChecker_exists_testset_local` from
  `antiChecker_exists_large_Y_local`, reducing the active axiom count to 4 and
  adding the corollary `antiChecker_exists_large_Y_local_from_testset`.
