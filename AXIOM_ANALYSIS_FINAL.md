...
- **Всего активных аксиом**: 3 (все расположены внутри каталога `pnp3/`).
- **Распределение**:
  - Part A (Switching/Shrinkage): 2
  - Part C (Anti-Checker): 1
...
| Part C | одна anti-checker аксиома (локальная версия) | Нижние границы против локальных схем | 🔴 Критично |
...
|----------|--------|-------------|
| `pnp3/Docs/AXIOMS.md` | ✅ Актуален | Содержит полный список 3 аксиом |
| `AXIOMS_FINAL_LIST.md` | ✅ Актуален | Подготовленная сводка для публикации |
| `AXIOM_FEASIBILITY_ANALYSIS.md` | ✅ Актуален | Пересчитаны трудозатраты для 3 аксиом |
...
1. В актуальной ветке задействовано **3 внешние аксиомы**, все они относятся к
...
4. **Дальнейшая работа** должна сосредоточиться на снятии локального
   anti-checker (Part C) и, в долгосрочной перспективе, switching (Part A).
