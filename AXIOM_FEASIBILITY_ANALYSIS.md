...
## Part D — Magnification (1 аксиома + 2 доказанные специализации)

### D.1 `OPS_trigger_general` (доказано)
### D.2 `OPS_trigger_formulas` (доказано как специализация D.1)
### D.3 `Locality_trigger` (доказано)
...
перспективе. Частичное закрытие уже достигнуто: D.1, D.2 и D.3 формализованы,
остаётся заменить аксиому D.4.

---

## Приоритеты и рекомендации

1. **Документация обновлена**: интерфейсы исключены из списка аксиом, осталось 7
   внешних утверждений.
