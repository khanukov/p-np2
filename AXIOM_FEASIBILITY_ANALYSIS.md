...
**Всего активных аксиом**: 3
**Структура**: 2 (Switching) + 1 (Anti-Checker) + 0 (Magnification — все доказаны)
...
перспективы снятия оставшихся трёх аксиом.
...
| Part C — Anti-Checker | 1 | 😈 Очень сложно | 400–900 | Игра "Circuit vs Spoiler", комбинаторика OPS |
...
## Part C — Anti-Checker (1 аксиома + 3 доказанные теоремы)

### (proved) `antiChecker_exists_large_Y`
### C.3 `antiChecker_exists_large_Y_local`
### (proved) `antiChecker_exists_testset`
...
1. **Документация обновлена**: интерфейсы исключены из списка аксиом, осталось 3
   внешних утверждения (AC⁰ античекерная аксиома заменена теоремой).
2. **Стратегия на ближайшее время**:
   - сосредоточиться на формализации anti-checker (Part C), начиная с локальной
     версии `antiChecker_exists_large_Y_local`;
