...
## Part D — Magnification (2 аксиомы + 1 доказанная специализация)
...
перспективе. Частичное закрытие уже достигнуто: D.1 и D.2 формализованы,
остаётся заменить аксиомы D.3 и D.4.

---

## Приоритеты и рекомендации

1. **Документация обновлена**: интерфейсы исключены из списка аксиом, осталось 8
   внешних утверждений.
