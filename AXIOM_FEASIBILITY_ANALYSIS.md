...
## Обновлённая оценка трудоёмкости (состояние на 2025-12-25)

**Всего активных аксиом**: 2
**Структура**: 2 (Switching) + 0 (Anti-Checker — доказаны) + 0 (Magnification — все доказаны)
...
перспективы снятия оставшихся двух аксиом.
...
1. **Документация обновлена**: интерфейсы исключены из списка аксиом, осталось 2
   внешних утверждения (switching/shrinkage).
