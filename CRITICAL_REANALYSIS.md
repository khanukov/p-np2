...
(D.2, теперь доказанный). Остальные четыре аксиомы поддерживают обобщения
...
| Part C | `antiChecker_exists_large_Y`,<br>`antiChecker_exists_large_Y_local` | Anti-checker игры (глобальный `large_Y` базовый факт; версии с тестами доказаны) |
...
- `pnp3/LowerBounds/AntiChecker.lean` — две аксиомы (усиленные античекеры); базовая версия `antiChecker_exists_large_Y` доказана внутри файла, все тестовые формулировки превращены в теоремы.
