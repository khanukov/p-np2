...
/-!
# Straight-line simulation core

This module contains the straight-line circuit builders, snapshot machinery, and
quantitative lemmas that turn the configuration encodings from
