...
* `decisionTree_cover` now has a complete classical proof in `low_sensitivity_cover.lean`.  Future work focuses on sharpening the coarse numerical bounds used in the argument.
