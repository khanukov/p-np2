...
- ✅ Добавлены операция `Subcube.unfix` и усиленная лемма
  ...
  дальнейшего перехода к точечной монохроматичности.  Дополнительно введена
  однофункциональная лемма `monochromaticFor_extend_restrict`, показывающая, что
  расширение субкуба по нечувствительной координате сохраняет
  монохроматичность для исходной функции.
