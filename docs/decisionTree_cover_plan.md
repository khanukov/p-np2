...
3. **Интеграция в `decisionTree_cover`.**
   ...
   незавершённой задачей.
    ...
    совпадает с `R`; общий индуктивный разбор завершён: переход вдоль
    основной ветви построен индуктивно и исключено вырожденное
    совпадение подкуба с исходным.  В качестве подготовки добавлена
