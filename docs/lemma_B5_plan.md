...
4.1. Гипотеза `h_true`
- [ ] Сформулировать и доказать вспомогательную лемму, выводящую непустое множество общих единичных точек $Pts$ из инвариантов рекурсивной конструкции (`firstUncovered`, `uncovered`). Это позволит автоматически поставлять базовую точку для шага подсолнуха.
