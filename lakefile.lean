...
lean_lib Pnp4 where
  ...
  globs := #[
    ...
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPRegionScanOnesSegments,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPRegionZoneWalkHop,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPRegionValuePushHop,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPRegionUnaryTransferHop,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPPopIterProgram,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPConstIterProgram,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPConstIterRun,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPConstWriteChain,
    ...
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPPushCtrlFrameRealizes,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPWriteNatField,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPWriteBitsExtends,
    ...
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPValuePushRun,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPValuePushConfined,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPValuePushHeadline,
    ...
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPCorridorSettleClear,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPValReplaceTop,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPCorridorPopStep,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPCorridorTerminalStep,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPCorridorLeafLast,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPDriverStepTape,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPDriverTapes,
    ...
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPDriverRealization,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPTranscoderCapstone,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPSettleProbe,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPAtomSeqP1,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPSettleProbeFrame,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPRegionEmbed,
    ...
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPRegionAtomHops,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPClearIterRun,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPRegionWriteSegment,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPCtrlTopWalk,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPRemWalk,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPDecIterProgram,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPDecIterRun,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPCertTrie,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPNodeIterProgram,
    Glob.one `Pnp4.Frontier.ContractExpansion.TreeMCSPNodeIterRun,
