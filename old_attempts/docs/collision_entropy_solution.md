> **Status (2025-09-24)**: Matches the implementation in `old_attempts/OldAttempts/collentropy.lean`.
>
...
implementation can be found in `old_attempts/OldAttempts/collentropy.lean`.
...
```bash
lake exe cache get
lake build OldAttempts.collentropy
```
