> **Status (2025-09-24)**: Updated after removing the `P_subset_Ppoly` axiom; only the magnification bridge remains axiomatic in `old_attempts/OldAttempts/NP_separation.lean`.
>
