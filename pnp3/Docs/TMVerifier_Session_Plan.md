...
> `249435bf`; see `pnp3/Docs/TMVERIFIER_FREEZE.md`, whose migration record
> covers the single reviewed unfreeze since `42c59881` (S11 below). Do not
> resume GN-E2-3b or later stages. Active work has moved to a versioned uniform
> complexity foundation outside the frozen tree.
