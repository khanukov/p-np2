...
/--
Final generic theorem: table-force + slack + slice-constancy + NP-entry imply
`NP_not_subset_PpolyDAG`.

After this reduction, the remaining work is purely family-specific
instantiation of the listed hypotheses.
-/
