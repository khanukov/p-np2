...
set_option linter.deprecated false in
theorem check_deprecated_GapPartialMCSP_in_AC0 (p : GapPartialMCSPParams) :
    GapPartialMCSP_in_AC0 p ↔ EnrichedSmallAC0PackagePartialExists p :=
  Iff.rfl

set_option linter.deprecated false in
theorem check_deprecated_GapPartialMCSP_not_in_AC0 (p : GapPartialMCSPParams) :
    GapPartialMCSP_not_in_AC0 p ↔
      EnrichedSmallAC0PackagePartialInconsistent p :=
  Iff.rfl

set_option linter.deprecated false in
theorem check_deprecated_gapPartialMCSP_no_semantic_AC0_solver
    (p : GapPartialMCSPParams) :
    ∀ _solver : SmallAC0Solver_Partial p, False :=
  gapPartialMCSP_no_semantic_AC0_solver p

set_option linter.deprecated false in
theorem check_deprecated_gapPartialMCSP_no_syntactic_AC0_solver
    (p : GapPartialMCSPParams) :
    ∀ _solver : SmallAC0Solver_Partial_Syntactic p, False :=
  gapPartialMCSP_no_syntactic_AC0_solver p

set_option linter.deprecated false in
theorem check_deprecated_gapPartialMCSP_no_constructive_AC0_solver
    (p : GapPartialMCSPParams) :
...
set_option linter.deprecated false in
theorem check_deprecated_gapPartialMCSP_notInSmallAC0_of_not_in_AC0
    (p : GapPartialMCSPParams) :
    GapPartialMCSP_NotInSmallAC0 p :=
  gapPartialMCSP_notInSmallAC0_of_not_in_AC0 p

set_option linter.deprecated false in
theorem check_deprecated_gapPartialMCSP_not_in_AC0_iff_notInSmallAC0
    (p : GapPartialMCSPParams) :
...
set_option linter.deprecated false in
theorem check_deprecated_GapPartialMCSP_NotInSmallAC0
    (p : GapPartialMCSPParams) :
    GapPartialMCSP_NotInSmallAC0 p ↔
      EnrichedSmallAC0PackagePartialInconsistent p :=
  Iff.rfl
...
set_option linter.deprecated false in
theorem check_deprecated_gapPartialMCSP_noSmallAC0Solver
    (p : GapPartialMCSPParams) :
    ∀ _solver : SmallAC0Solver_Partial p, False :=
  gapPartialMCSP_noSmallAC0Solver p

set_option linter.deprecated false in
theorem check_deprecated_gapPartialMCSP_noSyntacticSmallAC0Solver
    (p : GapPartialMCSPParams) :
    ∀ _solver : SmallAC0Solver_Partial_Syntactic p, False :=
  gapPartialMCSP_noSyntacticSmallAC0Solver p

set_option linter.deprecated false in
theorem check_deprecated_gapPartialMCSP_noConstructiveSmallAC0Solver
    (p : GapPartialMCSPParams) :
    ∀ _solver : ConstructiveSmallAC0Solver_Partial p, False :=
...
set_option linter.deprecated false in
theorem check_deprecated_gapPartialMCSP_notInSmallAC0_syntactic
    (p : GapPartialMCSPParams) :
    ¬ ∃ _solver : SmallAC0Solver_Partial_Syntactic p, True :=
  gapPartialMCSP_notInSmallAC0_syntactic p

set_option linter.deprecated false in
theorem check_deprecated_gapPartialMCSP_notInSmallAC0_constructive
    (p : GapPartialMCSPParams) :
...
set_option linter.deprecated false in
theorem check_deprecated_noSmallAC0Solver_partial_of_family_card
    {p : GapPartialMCSPParams}
