...
/-!
  ...
  Core-cone audit: all intermediate nodes below final theorems should depend
  only on Lean's classical base axioms (`propext`, `Classical.choice`,
  `Quot.sound`) and not on project-specific external scaffolding.
-/
...
#print axioms LB_GeneralFromLocal_partial
