...
theorem check_G1RunSafe_empty := @G1RunSafe.empty
theorem check_G1RunSafe_succ := @G1RunSafe.succ
theorem check_G1RunSafe_add := @G1RunSafe.add
theorem check_G1RunSafe_transport := @G1RunSafe.transport
