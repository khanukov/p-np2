...
The surface is deliberately narrow: one machine-independent bridge, four
move-specific corollaries, and a probe.  Nothing here claims acceptance, a
runtime bound, or any verifier property.
-/
