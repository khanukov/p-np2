...
The Part A fixed-phase chain, including the G2x composed decrement/countdown machine and the
G2y composed loop/decrement/countdown machine that contains it, lives
