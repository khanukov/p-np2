...
import Pnp4.Frontier.OneTapeMagnification.FiniteUnambiguousFBDDSameWalkSiblingLiteralFactorization
import Pnp4.Frontier.OneTapeMagnification.FiniteUnambiguousFBDDCanonicalWalkCellEnergyPacking
import Pnp4.Frontier.OneTapeMagnification.FiniteUnambiguousFBDDCanonicalWalkCellFixedDualPacking
import Pnp4.Frontier.OneTapeMagnification.FiniteBooleanStructuredDualFourierL1
import Pnp4.Frontier.OneTapeMagnification.FiniteUnambiguousFBDDCanonicalWalkCellFourierL1
import Pnp4.Frontier.OneTapeMagnification.FiniteFixedOrderSiblingConflictCoverObstruction
...
import Pnp4.Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementPairPhaseImbalance
import Pnp4.Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction
...
import Pnp4.Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralDualAggregation
...
#check Frontier.OneTapeMagnification.FiniteSignedReverseLCPTerminalBoundary.suffixTerminalBoundaryMass_eq_exactTraceMass
#check Frontier.OneTapeMagnification.FiniteSignedReverseLCPTerminalBoundary.exactLCSPairCharge_eq_terminalBoundary_sq_add_orderedSiblingCross_of_suffix_free
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.canonicalInputLabelledFullTrace_suffix_free
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.canonicalInputLabelledFullTrace_injective_of_readsAll
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.canonicalResidualDeviationTerminalBoundaryMass_eq_accepted_of_readsAll
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.canonicalExactLCPSignedPairCharge_eq_terminalBoundary_sq_add_orderedSiblingCross
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.Walk.exists_commonOppositeQuery_of_ne
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.Walk.exists_oppositeInputLabelledQueryEvents_of_ne
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.Walk.firstCommonOppositeQueryOfNe_spec
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.Walk.compatible_of_pointwise_realizable
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.Walk.exists_uniformlyOppositeQueryCoordinate_of_ne
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.Walk.exists_uniformlyOppositeLiteral_of_ne
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.Walk.firstUniformlyOppositeQueryOfNe_spec
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.exists_commonOppositeQuery_of_canonicalInputLabelledFullTrace_ne
...
#check Frontier.OneTapeMagnification.DPTWStructuredMaskRankInsertion.supportPrefixConstraintRank_insert_bounds
#check Frontier.OneTapeMagnification.DPTWStructuredMaskRankInsertion.dyadicRankWeight_sub_insert_bounds
...
#check Frontier.OneTapeMagnification.FiniteStructuredDualRankThresholdBridge.finiteDyadicRankWeightedSum_eq_terminal_add_cumulative
#check Frontier.OneTapeMagnification.FiniteStructuredDualRankThresholdBridge.structuredDualRankDistinctCrossForm_eq_terminal_add_cumulative
#check Frontier.OneTapeMagnification.FiniteStructuredDualRankThresholdBridge.structuredRankWeightedDualFarPairCorrelation_eq_terminal_add_cumulative
#check Frontier.OneTapeMagnification.FiniteStructuredDualRankThresholdBridge.structuredDualRankAtMostCrossForm_terminal_le_four
#check Frontier.OneTapeMagnification.FiniteStructuredDualRankThresholdBridge.StructuredDualRankStrictIntermediateCumulativeBound
#check Frontier.OneTapeMagnification.FiniteStructuredDualRankThresholdBridge.structuredDualRankCumulativeBound_four_iff_strictIntermediate_of_bounded
#check Frontier.OneTapeMagnification.FiniteStructuredDualRankThresholdBridge.structuredRankWeightedDualFarPairCorrelation_le_dualFarBudget_of_cumulativeFour
#check Frontier.OneTapeMagnification.FiniteStructuredDualRankThresholdBridge.dualFarBound_of_structuredDualRankCumulativeFour
#check Frontier.OneTapeMagnification.FiniteStructuredDualHyperplaneContraction.hyperplaneSurvivalWeight
#check Frontier.OneTapeMagnification.FiniteStructuredDualHyperplaneContraction.dyadicRankWeight_eq_hyperplane_mixture
#check Frontier.OneTapeMagnification.FiniteStructuredDualHyperplaneContraction.structuredDualRankDistinctCrossForm_eq_hyperplane_add_terminal
#check Frontier.OneTapeMagnification.FiniteStructuredDualHyperplaneContraction.structuredRankWeightedDualFarPairCorrelation_eq_hyperplane_add_terminal
#check Frontier.OneTapeMagnification.FiniteStructuredDualHyperplaneContraction.StructuredDualHyperplaneContraction
#check Frontier.OneTapeMagnification.FiniteStructuredDualHyperplaneContraction.structuredRankWeightedDualFarPairCorrelation_le_cap_mul_baseWeight_of_hyperplaneContraction
#check Frontier.OneTapeMagnification.FiniteStructuredDualHyperplaneContraction.dualFarBound_of_structuredDualHyperplaneContraction
#check Frontier.OneTapeMagnification.FiniteStructuredDualHyperplaneContraction.generatedPrefixDualFarBound_of_structuredDualHyperplaneContraction
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorRankDispersion.selectorStructuredDualRankStrictDispersion
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorRankDispersion.selectorStructuredDualRankStrictDispersion_eq_cachedRunMax
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorRankDispersion.selectorStructuredDualRankStrictDispersion_nonneg
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorRankDispersion.selectorStructuredDualRankStrictDispersion_le_iff
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorRankDispersion.selectorStructuredDualRankStrictDispersion_le_four_iff
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorRankDispersion.dualFarBound_of_selectorStructuredDualRankStrictDispersion_le_four
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorRankDispersion.generatedPrefixDualFarBoundUpTo_of_selectorRankStrictDispersionFourUpTo
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorRankDispersion.abs_value_sub_value_zero_le_rounds_mul_pow_of_selectorRankStrictDispersionFourUpTo
#check Frontier.OneTapeMagnification.FiniteStructuredDualNonzeroSeedCorrelation.card_nonzeroBitSeeds
#check Frontier.OneTapeMagnification.FiniteStructuredDualNonzeroSeedCorrelation.finiteAverage_eq_nonzeroBitSeed_mixture
#check Frontier.OneTapeMagnification.FiniteStructuredDualNonzeroSeedCorrelation.structuredDyadicPrimitive_nonzeroSeed_maskSurvival_eq_hyperplaneWeight
#check Frontier.OneTapeMagnification.FiniteStructuredDualNonzeroSeedCorrelation.structuredDualPairCorrelationAtMask_self_eq_highTailFarPairCorrelation
#check Frontier.OneTapeMagnification.FiniteStructuredDualNonzeroSeedCorrelation.structured_fixedMask_highTail_secondMoment_eq_diagonal_add_pairCorrelation
#check Frontier.OneTapeMagnification.FiniteStructuredDualNonzeroSeedCorrelation.abs_structuredDualPairCorrelationAtMask_self_le_four
#check Frontier.OneTapeMagnification.FiniteStructuredDualNonzeroSeedCorrelation.structuredDualNonzeroSeedCrossCorrelation_eq_conditionalSecondMoment_sub_hyperplaneDiagonal
#check Frontier.OneTapeMagnification.FiniteStructuredDualNonzeroSeedCorrelation.structuredDualHyperplaneSmoothedCrossForm_eq_nonzeroSeedCorrelation
#check Frontier.OneTapeMagnification.FiniteStructuredDualNonzeroSeedCorrelation.structuredDualNonzeroSeedCrossCorrelation_le_four
#check Frontier.OneTapeMagnification.FiniteStructuredDualNonzeroSeedCorrelation.structuredDualNonzeroSeedCrossCorrelation_le_exactBudget_iff
#check Frontier.OneTapeMagnification.FiniteStructuredDualNonzeroSeedCorrelation.dualFarBound_iff_mandatorySelectorNonzeroSeedExactBudget
#check Frontier.OneTapeMagnification.FiniteStructuredDualNonzeroSeedCorrelation.dualFarBound_iff_cachedRunNonzeroSeedExactBudget
#check Frontier.OneTapeMagnification.FiniteStructuredDualNonzeroSeedCorrelation.generatedPrefixDualFarBound_iff_mandatorySelectorNonzeroSeedExactBudget
#check Frontier.OneTapeMagnification.FiniteStructuredDualNonzeroSeedCorrelation.generatedPrefixDualFarBound_of_mandatorySelectorNonzeroSeedFourBudget
...
/-! Exact fixed-alpha selector-pair factorization and masked-correlation surface. -/
#check Frontier.OneTapeMagnification.LayeredQueryProgram.InputsAgreeOnQueryTrace
#check Frontier.OneTapeMagnification.LayeredQueryProgram.finalState_eq_of_inputsAgreeOnQueryTrace
#check Frontier.OneTapeMagnification.LayeredQueryProgram.eval_eq_of_inputsAgreeOnQueryTrace
#check Frontier.OneTapeMagnification.LayeredQueryProgram.queryTrace_eq_of_inputsAgreeOnQueryTrace
#check Frontier.OneTapeMagnification.FiniteBooleanMaskedProductFactorization.finiteAverage_pi_dep_prod
#check Frontier.OneTapeMagnification.FiniteBooleanMaskedProductFactorization.dependsOnlyOn_finset_prod
#check Frontier.OneTapeMagnification.FiniteBooleanMaskedProductFactorization.finiteAverage_finset_prod_maskedInput_eq_prod
#check Frontier.OneTapeMagnification.allFixedAlphaBlockVisitListsAcceptedFromBlank_singleBlockSplice
#check Frontier.OneTapeMagnification.allFixedAlphaBlockVisitListsAcceptedFromBlank_allBlockSplice
#check Frontier.OneTapeMagnification.fixedAlphaBlockVisitListCrossingProfile_eq_of_pathAgreement
#check Frontier.OneTapeMagnification.finiteRatPropIndicator_inPlaceCanonicalCutCheck_eq_factorGraph
#check Frontier.OneTapeMagnification.finiteCachedTimedScheduleBlockQuerySupport_disjoint_of_scheduleReplay
#check Frontier.OneTapeMagnification.finiteRatPropIndicator_cachedInPlaceCanonicalCutCheck_eq_threeLayers
#check Frontier.OneTapeMagnification.finiteAverage_unaryTensorLayer_maskedInput_eq_prod
#check Frontier.OneTapeMagnification.finiteAverage_evenSelectorPairTensorLayer_maskedInput_eq_prod
#check Frontier.OneTapeMagnification.finiteAverage_oddSelectorPairTensorLayer_maskedInput_eq_prod
#check Frontier.OneTapeMagnification.advertisedSelectedCutMultiplicity_eq_actual_of_scheduleReplay
#check Frontier.OneTapeMagnification.timedAlphaVisitScheduleInPlaceCanonicalCutCheck_allBlockSplice
#check Frontier.OneTapeMagnification.TimedAlphaCanonicalBlockProjection
#check Frontier.OneTapeMagnification.timedAlphaVisitScheduleInPlaceCanonicalCutCheck_iff_blockProjections
#check Frontier.OneTapeMagnification.finiteRatPropIndicator_inPlaceCanonicalCutCheck_eq_blockProjectionProduct
#check Frontier.OneTapeMagnification.finiteAverage_inPlaceCanonicalCutCheck_maskedInput_eq_projectionProd
#check Frontier.OneTapeMagnification.finiteAverage_inPlaceCanonicalCutCheck_maskedInput_eq_projectionProd_of_replay
#check Frontier.OneTapeMagnification.FiniteBooleanDisjointProductFourierFactorization.finiteAverage_finset_prod_eq_prod
#check Frontier.OneTapeMagnification.FiniteBooleanDisjointProductFourierFactorization.coefficient_finset_prod_eq_prod_inter_of_subset
#check Frontier.OneTapeMagnification.FiniteBooleanDisjointProductFourierFactorization.coefficient_finset_prod_eq_if_subset
#check Frontier.OneTapeMagnification.coefficient_inPlaceCanonicalCutCheck_eq_if_projectionProduct
#check Frontier.OneTapeMagnification.coefficient_builtInPlaceCanonicalCutCheck_eq_if_projectionProduct
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonicalSelectorMasterEndTrueVertex
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonicalSelectorMasterEnd_hasCompatiblePrefix_iff_eval_true
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonicalSelectorMasterEnd_ratCompatiblePrefixIndicator_eq_factorGraph
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonical_ratComponentAcceptanceIndicator_eq_blockProjectionProduct
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonicalSelectorMasterEnd_ratCompatiblePrefixIndicator_eq_blockProjectionProduct
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonicalSelector_ratAcceptanceIndicator_eq_sum_blockProjectionProducts
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonicalSelector_finiteAverage_maskedInput_eq_sum_projectionProd
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonicalBlockProjectionFourierTerm
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonical_ratComponentAcceptanceIndicator_eq_blockProjectionProduct_fin
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonical_ratComponentAcceptanceIndicator_coefficient_eq_blockProjectionTerm
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonicalSelector_coefficient_eq_sum_blockProjectionTerms
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonicalSelector_coefficient_mul_coefficient_eq_sum_pairProjectionTerms
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonical_sameComponent_fullAliasCorrelation_eq_coefficient
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonical_distinctComponents_fullAliasCorrelation_eq_zero
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonical_distinctBlockProjection_fullAliasCorrelation_eq_zero
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonical_sameBlockProjection_fullAliasCorrelation_eq_term
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonical_allBlockProjectionPairs_fullAliasCorrelation_eq_diagonalSum
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonicalSelector_fullAliasCorrelation_eq_allBlockProjectionPairs
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonicalSelector_fullAliasCorrelation_eq_diagonalSum
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonicalSelector_fullAliasCorrelation_eq_coefficient
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonicalBlockProjectionAliasTerm
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonical_distinctBlockProjection_weightedHighHighAlias_decomposition
#check Frontier.OneTapeMagnification.FiniteBooleanAffineRoundsLocality.dependsOnlyOn_applyAffineRestrictionRounds
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.prefixedMandatoryCanonicalComponentIndicator
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.prefixedMandatoryCanonicalBlockProjectionFourierTerm
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.prefixedMandatoryCanonicalComponentIndicator_eq_blockProjectionProduct
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.prefixedMandatoryCanonicalComponent_coefficient_eq_blockProjectionTerm
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.prefixedMandatoryCanonicalSelector_coefficient_eq_sum_blockProjectionTerms
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.prefixedMandatoryCanonical_sameComponent_fullAliasCorrelation_eq_coefficient
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.prefixedMandatoryCanonical_distinctBlockProjection_fullAliasCorrelation_eq_zero
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.prefixedMandatoryCanonical_sameBlockProjection_fullAliasCorrelation_eq_term
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.prefixedMandatoryCanonical_allBlockProjectionPairs_fullAliasCorrelation_eq_diagonalSum
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.prefixedMandatoryCanonicalSelector_fullAliasCorrelation_eq_coefficient
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.prefixedMandatoryCanonicalBlockProjectionAliasTerm
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.prefixedMandatoryCanonical_distinctBlockProjection_weightedHighHighAlias_decomposition
#check Frontier.OneTapeMagnification.FiniteRankWeightAbelVariation.selectedWeightVariation_dyadicRank_eq_neg_sum_strictRankTails
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.fixedDualAliasUnionRank_lower
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.fixedDualAliasUnionRank_upper
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.prefixedMandatoryCanonical_distinctBlockProjection_rankWeightedHighHighAlias_eq
#check Frontier.OneTapeMagnification.FiniteBooleanFixedDualRankAbel.weightedSelectedSum_dyadicRank_eq_base_mul_total_sub_rejected_sub_strictRankTails
#check Frontier.OneTapeMagnification.FiniteBooleanFixedDualRankAbel.selectedStrictRankTail_add_selectedRankAtMostSum
#check Frontier.OneTapeMagnification.FiniteBooleanFixedDualRankAbel.boolean_fixedDual_highHighAliasSum_eq_coefficient_sub_rejected
#check Frontier.OneTapeMagnification.FiniteBooleanFixedDualRankAbel.boolean_fixedDual_strictRankTail_add_rankAtMost_eq
#check Frontier.OneTapeMagnification.FiniteBooleanFixedDualRankAbel.boolean_fixedDual_rankWeightedHighHighAlias_eq
#check Frontier.OneTapeMagnification.FiniteStructuredDualFixedDifferenceReindex.fixedDifferencePairEquiv
#check Frontier.OneTapeMagnification.FiniteStructuredDualFixedDifferenceReindex.fixedDifferencePairEquiv_mem_iff
#check Frontier.OneTapeMagnification.FiniteStructuredDualFixedDifferenceReindex.structuredDualRankDistinctCrossForm_eq_sum_fixedDualRankWeightedHighHigh
#check Frontier.OneTapeMagnification.FiniteStructuredDualFixedDifferenceReindex.structuredDualRankAtMostCrossForm_eq_sum_fixedDualRankAtMostHighHigh
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralCorrelation.coefficient_falseLiteralPart
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralCorrelation.coefficient_trueLiteralPart
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralCorrelation.oppositeLiteralFixedDualCrossForm_eq_sum_coordinateFreeTogglePairs
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralCorrelation.oppositeLiteralFixedDualTerm_add_toggle_eq_insertDerivative
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralCorrelation.oppositeLiteralFixedDualTerm_add_toggle_eq_zero_of_mem_of_bothHigh
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralCorrelation.structuredActualRankOppositeLiteralPair_eq_insertRankDerivative
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralCorrelation.structuredDualRankDistinctOppositeLiteralCrossForm_eq_coordinateFreePairs
#check Frontier.OneTapeMagnification.FiniteBooleanLiteralSupportFactorization.freezeCoordinate_dependsOnlyOn_erase
#check Frontier.OneTapeMagnification.FiniteBooleanLiteralSupportFactorization.paired_literal_support_factorization
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.Walk.exists_oppositeLiteralFactorization_of_ne
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.canonicalWalkSuffixConeCellIndicator_supportedOnCompatibleFiber
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.canonicalResidualSuffixConeIndicator_eq_sum_canonicalWalkCells
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.exists_oppositeLiteralFactorization_canonicalWalkSuffixConeCells_of_ne
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.canonicalResidualSuffixConeIndicators_mul_eq_sum_walkPairRectangles
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.Walk.exists_alignedOppositeQuery_of_distinct_sibling_suffixes
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.canonicalWalkSuffixConeCellIndicator_eq_zero_of_queryStep
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.exists_oppositeLiteralFactorization_sameWalkSiblingCells
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.canonicalWalkSuffixConeCellIndicator_eq_compatibleSuffixIndicator
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.canonicalWalkSuffixConeCellIndicator_dependsOnlyOn_queryVars
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.sum_canonicalWalkCell_sq_eq_cone_sq
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.sum_canonicalWalkCell_fourierEnergy_eq_cone_fourierEnergy
#check Frontier.OneTapeMagnification.FiniteCanonicalWalkCellFixedDualPacking.abs_fixedDualWeightedHighHighCrossForm_le_energy
#check Frontier.OneTapeMagnification.FiniteCanonicalWalkCellFixedDualPacking.abs_structuredActualRankWeight_fixedDualUnion_le
#check Frontier.OneTapeMagnification.FiniteCanonicalWalkCellFixedDualPacking.abs_structuredFixedDualHighHighCrossForm_le_energy
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.fixedDualHighHighCrossForm_cones_eq_walkCellPairSum
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.abs_canonicalWalkCellPairFixedDualSum_le_coneEnergy
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.abs_structuredCanonicalWalkCellPairFixedDualSum_le_coneEnergy
#check Frontier.OneTapeMagnification.FiniteBooleanStructuredDualFourierL1.abs_weightedFourierPairCrossForm_le_fourierL1_mul
#check Frontier.OneTapeMagnification.FiniteBooleanStructuredDualFourierL1.abs_structuredDualRankDistinctCrossForm_le_fourierL1_mul
#check Frontier.OneTapeMagnification.FiniteBooleanStructuredDualFourierL1.abs_structuredDualRankDistinctCrossForm_le_baseWeight_of_fourierL1
#check Frontier.OneTapeMagnification.FiniteBooleanStructuredDualFourierL1.fourierL1_ratFixedLabelledSuffixCylinderIndicator_eq_one
#check Frontier.OneTapeMagnification.FiniteBooleanStructuredDualFourierL1.abs_structuredDualRankDistinctCrossForm_fixedCylinders_le
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.fourierL1_mul_le
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.Walk.fourierL1_ratCompatibilityIndicator_le_one
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.canonicalWalkSuffixConeCellIndicator_eq_prefixCompatibility_mul_suffixCylinder
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.fourierL1_canonicalWalkSuffixConeCellIndicator_le_one_of_realized
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.abs_structuredDualRankDistinctCrossForm_canonicalWalkCells_le
#check Frontier.OneTapeMagnification.FiniteFixedOrderSiblingConflictCoverObstruction.zeroBooleanInput_ne_unitBooleanInput_iff
#check Frontier.OneTapeMagnification.FiniteFixedOrderSiblingConflictCoverObstruction.zeroUnitCommonConflictGrouping_groupOf_injective
#check Frontier.OneTapeMagnification.FiniteFixedOrderSiblingConflictCoverObstruction.card_group_ge_of_zeroUnitCommonConflictGrouping
#check Frontier.OneTapeMagnification.FiniteFixedOrderSiblingConflictCoverObstruction.atMostOneFixedOrderProgram_hasFixedQueryOrder
#check Frontier.OneTapeMagnification.FiniteFixedOrderSiblingConflictCoverObstruction.atMostOneFixedOrderProgram_isReadOnce
#check Frontier.OneTapeMagnification.FiniteFixedOrderSiblingConflictCoverObstruction.atMostOneFixedOrderProgram_final_sameLabel_merge
#check Frontier.OneTapeMagnification.FiniteStructuredDualSyndromeFiberBlocks.structuredDualPowerSyndrome_symmDiff
#check Frontier.OneTapeMagnification.FiniteStructuredDualSyndromeFiberBlocks.isStructuredDualSupport_symmDiff_iff_syndrome_eq
#check Frontier.OneTapeMagnification.FiniteStructuredDualSyndromeFiberBlocks.structuredMaskedHighDiagonalCrossTerm_eq
#check Frontier.OneTapeMagnification.FiniteStructuredDualSyndromeFiberBlocks.structuredDualPairCorrelationAtMask_eq_syndromeFiberBlocks_sub_diagonal
#check Frontier.OneTapeMagnification.FiniteStructuredDualSyndromeFiberBlocks.structuredDualRankDistinctCrossForm_eq_finiteAverage_syndromeFiberBlocks
#check Frontier.OneTapeMagnification.FiniteStructuredDualBlockProductSyndromeTransform.structuredMaskedHighDegreeTransform_eq_fixedMask_sub_low
#check Frontier.OneTapeMagnification.FiniteStructuredDualBlockProductSyndromeTransform.structuredMaskedHighDegreeTransform_disjointProduct_eq_prod_sub_low
#check Frontier.OneTapeMagnification.FiniteStructuredDualBlockProductSyndromeTransform.syndromeFiberInnerProduct_eq_finiteAverage_highTransforms
#check Frontier.OneTapeMagnification.FiniteStructuredDualBlockProductSyndromeTransform.syndromeFiberEnergy_disjointProduct_eq_average_prod_sub_low_sq
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonicalBlockProjectionStructuredTransform
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonicalComponentStructuredLowDegreePolynomial
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonicalComponent_syndromeFiberEnergy_eq_average_blockProduct_sub_low_sq
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.prefixedMandatoryCanonicalBlockProjectionStructuredTransform
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.prefixedMandatoryCanonicalComponentStructuredLowDegreePolynomial
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.prefixedMandatoryCanonicalComponent_syndromeFiberEnergy_eq_average_blockProduct_sub_low_sq
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonicalSelectorBlockProductStructuredTransform
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonicalSelectorStructuredLowDegreePolynomial
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonicalSelector_fixedMaskAveragedFunction_eq_blockProductTransform
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonicalSelector_syndromeFiberEnergy_eq_average_sumBlockProducts_sub_low_sq
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.mandatoryCanonicalSelectorBlockProductStructuredTransform_mem_unitInterval
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.prefixedMandatoryCanonicalSelectorBlockProductStructuredTransform
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.prefixedMandatoryCanonicalSelectorStructuredLowDegreePolynomial
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.prefixedMandatoryCanonicalSelector_fixedMaskAveragedFunction_eq_blockProductTransform
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.prefixedMandatoryCanonicalSelector_syndromeFiberEnergy_eq_average_sumBlockProducts_sub_low_sq
#check Frontier.OneTapeMagnification.FiniteLayeredQueryProgramFamily.prefixedMandatoryCanonicalSelectorBlockProductStructuredTransform_mem_unitInterval
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFrameBridge.sub_le_one_sub_mul_pow_of_frame_and_diagonal
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFrameBridge.finite_fiberwise_bessel_implies_frame
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFrameBridge.structuredSyndromeEnergyAverage
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFrameBridge.structuredMaskedHighDiagonalAverage
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFrameBridge.structuredMaskedHighDiagonalAverage_eq_sum
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFrameBridge.structuredDualRankDistinctCrossForm_eq_energy_sub_diagonal
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFrameBridge.StructuredSyndromeFrameBound
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFrameBridge.structuredSyndromeFrameBound_of_fiberwise
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFrameBridge.structuredDualRankDistinctCrossForm_le_of_syndromeFrameBound
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFrameBridge.PrefixedMandatoryCanonicalSelectorSyndromeFrameBound
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFrameBridge.dualFarBound_of_prefixedMandatoryCanonicalSelectorSyndromeFrameBound
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFrameBridge.GeneratedPrefixSyndromeFrameBound
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFrameBridge.GeneratedPrefixSyndromeFrameBoundUpTo
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFrameBridge.generatedPrefixDualFarBound_of_generatedPrefixSyndromeFrameBound
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFrameBridge.generatedPrefixDualFarBoundUpTo_of_generatedPrefixSyndromeFrameBoundUpTo
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFramePointMassObstruction.allFalseWord
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFramePointMassObstruction.structuredDyadicPrimitive_generate_zeroBitSeed
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFramePointMassObstruction.dyadicRankWeight_sq_mul_zeroSeedTransform_sq_le_syndromeEnergyAverage
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFramePointMassObstruction.structuredMaskedHighDiagonalAverage_le_fullFourierEnergy
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFramePointMassObstruction.structuredMaskedHighDiagonalAverage_zeroPointIndicator_le
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFramePointMassObstruction.pow_sub_cutoff_succ_le_card_highDegreeSupports
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFramePointMassObstruction.structuredMaskedHighDegreeTransform_zeroPointIndicator_zeroSeeds_eq
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFramePointMassObstruction.not_structuredSyndromeFrameBound_of_zeroSeedSpike
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFramePointMassObstruction.not_structuredSyndromeFrameBound_zeroPointIndicator
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFramePointMassObstruction.not_structuredSyndromeFrameBound_zeroPointIndicator_of_card_scale
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFramePointMassObstruction.not_structuredSyndromeFrameBound_zeroPointIndicator_of_free_family_scale
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorSyndromeFramePointMassObstruction.not_structuredSyndromeFrameBound_zeroPointIndicator_n7_m1
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorAbsoluteSyndromeEnergy.structuredMaskedHighDegreeTransform_eq_highTailAverage
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorAbsoluteSyndromeEnergy.structuredSyndromeEnergyAverage_eq_highTailSecondMoment
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorAbsoluteSyndromeEnergy.structuredSyndromeEnergyAverage_eq_residualMassSecondMoment
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorAbsoluteSyndromeEnergy.prefixedMandatoryCanonicalSelector_structuredSyndromeEnergyAverage_eq_blockProductSecondMoment
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorAbsoluteSyndromeEnergy.PrefixedMandatoryCanonicalSelectorAbsoluteSyndromeEnergyBound
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorAbsoluteSyndromeEnergy.prefixedMandatoryCanonicalSelectorAbsoluteSyndromeEnergyBound_iff_residualMassL2Bound
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorAbsoluteSyndromeEnergy.prefixedMandatoryCanonicalSelectorAbsoluteSyndromeEnergyBound_iff_blockProductSecondMoment_le
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorAbsoluteSyndromeEnergy.oneRoundError_le_pow_of_prefixedMandatoryCanonicalSelectorAbsoluteSyndromeEnergyBound
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorAbsoluteSyndromeEnergy.GeneratedPrefixAbsoluteSyndromeEnergyBoundUpTo
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorAbsoluteSyndromeEnergy.generatedPrefixAbsoluteSyndromeEnergyBoundUpTo_iff_generatedPrefixResidualMassL2BoundUpTo
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorAbsoluteSyndromeEnergy.abs_value_sub_value_zero_le_rounds_mul_pow_of_generatedPrefixAbsoluteSyndromeEnergyBoundUpTo
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorDefectiveSyndromeFrame.structuredMaskedHighDegreeTransform_eq_fixedMaskHighTail
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorDefectiveSyndromeFrame.fixedMask_syndromeFiberEnergy_le_four
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorDefectiveSyndromeFrame.finiteAverage_fixedMaskAveragedFunction_eq
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorDefectiveSyndromeFrame.fixedMask_syndromeFiberEnergy_le_two_mul_structuredMass_add_uniformMass
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorDefectiveSyndromeFrame.badSeedDensity
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorDefectiveSyndromeFrame.badEnvelopeAverage
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorDefectiveSyndromeFrame.finiteAverage_energy_le_of_good_bad_envelope
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorDefectiveSyndromeFrame.finiteAverage_energy_le_of_good_bad_density
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorDefectiveSyndromeFrame.badEnvelopeAverage_two_mul_add_const
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorDefectiveSyndromeFrame.fixedMaskSyndromeEnergy
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorDefectiveSyndromeFrame.fixedMaskHighDiagonal
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorDefectiveSyndromeFrame.StructuredRareBadMaskSyndromeFrameCertificate
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorDefectiveSyndromeFrame.structuredSyndromeEnergyAverage_le_pow_of_rareBadMaskCertificate
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorDefectiveSyndromeFrame.fixedMaskStructuredBaseMass
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorDefectiveSyndromeFrame.StructuredMassWeightedBadMaskSyndromeFrameCertificate
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorDefectiveSyndromeFrame.structuredSyndromeEnergyAverage_le_pow_of_massWeightedBadMaskCertificate
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorDefectiveSyndromeFrame.PrefixedMandatoryCanonicalSelectorRareBadMaskCertificate
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorDefectiveSyndromeFrame.residualMassL2Bound_of_prefixedRareBadMaskCertificate
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorDefectiveSyndromeFrame.oneRoundError_le_pow_of_prefixedRareBadMaskCertificate
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorDefectiveSyndromeFrame.PrefixedMandatoryCanonicalSelectorMassWeightedBadMaskCertificate
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorDefectiveSyndromeFrame.residualMassL2Bound_of_prefixedMassWeightedBadMaskCertificate
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorDefectiveSyndromeFrame.oneRoundError_le_pow_of_prefixedMassWeightedBadMaskCertificate
#check Frontier.OneTapeMagnification.BuiltNonacceptingCanonicalAlphaEligible
#check Frontier.OneTapeMagnification.BuiltNonacceptingCanonicalAlphaIndex
#check Frontier.OneTapeMagnification.card_builtNonacceptingCanonicalAlphaIndex_le_ambient
#check Frontier.OneTapeMagnification.builtNonacceptingCanonicalIndexMonotone
#check Frontier.OneTapeMagnification.builtNonacceptingCanonicalIndex_chained
#check Frontier.OneTapeMagnification.builtNonacceptingCanonicalIndex_master_nodup
#check Frontier.OneTapeMagnification.mandatoryBuiltNonacceptingCanonicalComponent
#check Frontier.OneTapeMagnification.mandatoryBuiltNonacceptingCanonicalComponent_eval_eq_total
#check Frontier.OneTapeMagnification.mandatoryBuiltNonacceptingCanonicalQueryOrder
#check Frontier.OneTapeMagnification.mandatoryBuiltNonacceptingCanonicalComponent_hasFixedQueryOrder
#check Frontier.OneTapeMagnification.mandatoryBuiltNonacceptingCanonicalQueryOrder_nodup
#check Frontier.OneTapeMagnification.mandatoryBuiltNonacceptingCanonicalComponent_width
#check Frontier.OneTapeMagnification.mandatoryFiniteNonacceptingCanonicalFamily
#check Frontier.OneTapeMagnification.mandatoryBuiltNonacceptingCanonicalComponent_alpha_eq
#check Frontier.OneTapeMagnification.mandatoryFiniteNonacceptingCanonicalFamily_accepting_index_unique
#check Frontier.OneTapeMagnification.mandatoryFiniteNonacceptingCanonicalFamily_eval_eq_true_iff
#check Frontier.OneTapeMagnification.mandatoryFiniteNonacceptingCanonicalFamily_isUnambiguous
#check Frontier.OneTapeMagnification.mandatoryCanonicalNonacceptingUFBDD
#check Frontier.OneTapeMagnification.mandatoryCanonicalNonacceptingUFBDD_accepts_iff_not_cached_acceptance
#check Frontier.OneTapeMagnification.mandatoryCanonicalNonacceptingUFBDD_accepts_iff_not_cached_acceptance_of_word
#check Frontier.OneTapeMagnification.mandatoryCanonicalNonacceptingUFBDD_accepts_iff_not_cached_acceptance_ofFn
#check Frontier.OneTapeMagnification.mandatoryCanonicalUFBDD_accepts_iff_cached_acceptance_of_word
#check Frontier.OneTapeMagnification.mandatoryCanonicalUFBDD_accepts_iff_cached_acceptance_ofFn
#check Frontier.OneTapeMagnification.mandatoryCanonicalNonacceptingUFBDD_accepts_iff_not_mandatoryCanonicalUFBDD
#check Frontier.OneTapeMagnification.mandatoryCanonicalNonacceptingUFBDD_isSyntacticallyReadOnce
#check Frontier.OneTapeMagnification.mandatoryCanonicalNonacceptingUFBDD_isUnambiguous
#check Frontier.OneTapeMagnification.mandatoryCanonicalNonacceptingUFBDD_acceptingPath_queryVars_eq_univ
#check Frontier.OneTapeMagnification.mandatoryCanonicalNonacceptingUFBDD_vertex_card
#check Frontier.OneTapeMagnification.mandatoryCanonicalNonacceptingUFBDD_ratAcceptanceIndicator_eq_one_sub
#check Frontier.OneTapeMagnification.prefixedMandatoryCanonicalNonacceptingSelector
#check Frontier.OneTapeMagnification.prefixedMandatoryCanonicalNonacceptingSelector_ratAcceptanceIndicator_eq_one_sub
#check Frontier.OneTapeMagnification.prefixedMandatoryCanonicalNonacceptingSelector_structural
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.frozenCompatibleInputs
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.mem_frozenCompatibleInputs
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.frozenInputOfLivePattern
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.frozenInputOfLivePattern_injective
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.image_univ_frozenInputOfLivePattern_eq_frozenCompatibleInputs
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.frozenCompatibleInputs_card
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.compatibleAcceptedInputs
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.mem_compatibleAcceptedInputs
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.compatibleRejectedInputs
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.mem_compatibleRejectedInputs
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.residualRejectedInputCount
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.image_compatibleAcceptedModels_eq_compatibleAcceptedInputs
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.compatibleAcceptedInputs_card_eq_residualAcceptedModelCount
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.residualAcceptedModelCount_add_residualRejectedInputCount_eq_pow_live
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.normalizedResidualRejectedInputCount
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.normalizedResidualRejectedInputCount_eq_one_sub
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.finiteAverage_normalizedResidualRejectedInputCount_eq_one_sub
#check Frontier.OneTapeMagnification.FiniteUnambiguousFBDD.fixedMaskStructuredAverage_normalizedResidualRejectedInputCount_eq_one_sub
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorBadMaskResidualCountBridge.fixedMaskStructuredBaseMass_prefixedMandatoryCanonicalSelector_eq
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorBadMaskResidualCountBridge.fixedMask_syndromeFiberEnergy_le_two_mul_structuredMass_add_two_mul_uniformMass_sub_diagonal
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedBadMaskFrame.complementFunction
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedBadMaskFrame.coefficient_complementFunction_of_nonempty
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedBadMaskFrame.fixedMaskAveragedFunction_complementFunction
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedBadMaskFrame.finiteAverage_complementFunction
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedBadMaskFrame.fixedMaskStructuredBaseMass_complementFunction
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedBadMaskFrame.structuredSyndromeFiberCoefficientSum_complementFunction_eq_neg
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedBadMaskFrame.fixedMaskSyndromeEnergy_complementFunction
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedBadMaskFrame.fixedMaskHighDiagonal_complementFunction
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedBadMaskFrame.fixedMaskComplementBalancedEnvelope
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedBadMaskFrame.fixedMaskSyndromeEnergy_le_complementBalancedEnvelope
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedBadMaskFrame.StructuredComplementBalancedBadMaskFrameCertificate
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedBadMaskFrame.structuredSyndromeEnergyAverage_le_pow_of_complementBalancedCertificate
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedBadMaskFrame.PrefixedMandatoryCanonicalSelectorComplementBalancedBadMaskCertificate
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedBadMaskFrame.residualMassL2Bound_of_prefixedComplementBalancedBadMaskCertificate
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedBadMaskFrame.oneRoundError_le_pow_of_prefixedComplementBalancedBadMaskCertificate
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedResidualCountBridge.prefixedAcceptedResidualEnvelopeSide
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedResidualCountBridge.prefixedRejectedResidualEnvelopeSide
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedResidualCountBridge.one_sub_fixedMaskStructuredBaseMass_prefixedMandatoryCanonicalSelector_eq_rejectedCount
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedResidualCountBridge.prefixedAcceptedResidualEnvelopeSide_eq
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedResidualCountBridge.prefixedRejectedResidualEnvelopeSide_eq
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedResidualCountBridge.fixedMaskComplementBalancedEnvelope_prefixedMandatoryCanonicalSelector_eq_residualCounts
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedResidualCountBridge.prefixedAcceptedResidualEnvelopeSide_add_rejected_eq
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedResidualCountBridge.prefixedComplementBalancedResidualCountBadCharge
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedResidualCountBridge.badEnvelopeAverage_prefixedComplementBalanced_eq_residualCountBadCharge
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedResidualCountBridge.PrefixedMandatoryCanonicalSelectorComplementBalancedResidualCountCertificate
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementBalancedResidualCountBridge.prefixedComplementBalancedResidualCountCertificate_iff
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementPairResidualCountBridge.prefixedMandatoryCanonicalNonacceptingSelector_ratAcceptanceIndicator_eq_complementFunction
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementPairResidualCountBridge.finiteAverage_prefixedMandatoryCanonicalNonacceptingSelector_eq_one_sub
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementPairResidualCountBridge.fixedMaskHighDiagonal_prefixedMandatoryCanonicalNonacceptingSelector_eq
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementPairResidualCountBridge.normalizedResidualAcceptedModelCount_prefixedNonaccepting_eq_rejectedInputCount
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementPairResidualCountBridge.finiteAverage_normalizedResidualAcceptedModelCount_prefixedNonaccepting_eq_rejectedInputCount
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementPairResidualCountBridge.prefixedAcceptingSelectorPairResidualEnvelopeSide
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementPairResidualCountBridge.prefixedNonacceptingSelectorPairResidualEnvelopeSide
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementPairResidualCountBridge.prefixedAcceptingSelectorPairResidualEnvelopeSide_eq
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementPairResidualCountBridge.prefixedNonacceptingSelectorPairResidualEnvelopeSide_eq
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementPairResidualCountBridge.fixedMaskComplementBalancedEnvelope_prefixedMandatoryCanonicalSelector_eq_pairResidualCounts
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementPairResidualCountBridge.prefixedComplementPairResidualCountBadCharge
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementPairResidualCountBridge.prefixedComplementBalancedResidualCountBadCharge_eq_pairResidualCountBadCharge
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementPairResidualCountBridge.badEnvelopeAverage_prefixedComplementBalanced_eq_pairResidualCountBadCharge
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementPairPhaseImbalance.prefixedComplementPairResidualPhaseImbalance
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementPairPhaseImbalance.prefixedAcceptingSelectorPairResidualEnvelopeSide_sub_nonaccepting_eq_phaseImbalance
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementPairPhaseImbalance.prefixedAcceptingSelectorPairResidualEnvelopeSide_add_nonaccepting_eq
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementPairPhaseImbalance.two_mul_min_prefixedComplementPairResidualEnvelopeSides_eq_phaseImbalance
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementPairPhaseImbalance.fixedMaskComplementBalancedEnvelope_prefixedMandatoryCanonicalSelector_eq_phaseImbalance
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementPairPhaseImbalance.prefixedComplementPairPhaseImbalanceBadCharge
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementPairPhaseImbalance.prefixedComplementPairResidualCountBadCharge_eq_phaseImbalanceBadCharge
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementPairPhaseImbalance.badEnvelopeAverage_prefixedComplementBalanced_eq_phaseImbalanceBadCharge
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementPairPhaseImbalance.PrefixedMandatoryCanonicalSelectorComplementPairPhaseImbalanceCertificate
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorComplementPairPhaseImbalance.prefixedComplementPairPhaseImbalanceCertificate_iff
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.nonzeroPointIndicator
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.coefficient_nonzeroPointIndicator_of_nonempty
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.structuredMaskedHighDegreeTransform_nonzeroPointIndicator_eq_neg
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.fixedMaskSyndromeEnergy_nonzeroPointIndicator_eq
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.fixedMaskHighDiagonal_nonzeroPointIndicator_eq
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.frozenCoordinates
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.survivingHighSupports
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.maskAllZeroIndicator_eq_one_of_subset_frozen
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.maskAllZeroIndicator_eq_zero_of_not_subset_frozen
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.structuredMaskedHighDegreeTransform_zeroPointIndicator_zeroBase_eq
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.fixedMaskHighDiagonal_zeroPointIndicator_eq
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.dyadicRankWeight_mul_zeroBitSeed_le_finiteAverage
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.dyadicRankWeight_mul_zeroBaseTransform_sq_le_fixedMaskSyndromeEnergy
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.pow_frozen_sub_three_le_card_survivingHighSupports
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.pow_thirtySeven_le_card_survivingHighSupports_of_forty_le_frozen
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.fixedMaskHighDiagonal_zeroPointIndicator_lt_half_mul_energy_of_forty
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.fixedMaskHighDiagonal_nonzeroPointIndicator_lt_half_mul_energy_of_forty
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.obstructionMask
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.manyFrozenMaskSeeds
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.frozenCoordinateCountRat
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.frozenCoordinateCountRat_eq_card
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.finiteAverage_frozenCoordinateCountRat_obstructionMask
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.frozenCoordinateCountRat_obstructionMask_le_bad_envelope
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.twentyFive_div_eightyNine_le_badSeedDensity_manyFrozenMaskSeeds
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.manyFrozenMaskSeeds_subset_bad_of_relative_frame_off_bad
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.badSeedDensity_mono
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.oneQuarter_lt_badSeedDensity_of_relative_frame_off_bad
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.finiteAverage_nonzeroPointIndicator_eq
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.nonzeroPointIndicator_nonneg
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.fixedMaskStructuredBaseMass_nonzeroPointIndicator_nonneg
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.badEnvelopeAverage_fixedMaskStructuredBaseMass_nonneg
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.structuredMaskedHighDiagonalAverage_nonzeroPointIndicator_nonneg
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.not_structuredMassWeightedBadMaskSyndromeFrameCertificate_nonzeroPointIndicator
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorMassWeightedCertificateComplementObstruction.no_structuredMassWeightedBadMaskSyndromeFrameCertificate_nonzeroPointIndicator
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralRankDerivative.abs_structuredActualRankOppositeLiteralPair_le_of_bulk
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralRankDerivative.abs_structuredActualRankOppositeLiteralPair_le_dualScale_of_bulk
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralFixedWAggregation.coordinateFreeFourierEnergy_falseLiteralPart_eq_half
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralFixedWAggregation.coordinateFreeFourierEnergy_trueLiteralPart_eq_half
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralFixedWAggregation.abs_structuredActualRankOppositeLiteralBulkFixedWSum_le_fourierEnergy
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralFixedWAggregation.abs_structuredActualRankOppositeLiteralBulkFixedWSum_le_averageSq
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralDualAggregation.finiteAverage_live_mul_maskSurvival_eq_rankWeight_sub_insert
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralDualAggregation.structuredDualPairCorrelationAtMask_eq_sum_fixedDual
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralDualAggregation.structuredOppositeLiteralBulkDualSumAtMask_eq_live_mul_crossCorrelation
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralDualAggregation.structuredActualRankOppositeLiteralBulkFixedWSum_eq_finiteAverage
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralDualAggregation.structuredActualRankOppositeLiteralBulkDualSum_eq_finiteAverage_crossCorrelation
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralDualAggregation.structuredDualPairCorrelationAtMask_symm
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralDualAggregation.structuredDualPairCorrelationAtMask_eq_quarter_polarization
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralDualAggregation.abs_structuredDualPairCorrelationAtMask_le_two_of_disjoint
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralDualAggregation.abs_structuredDualPairCorrelationAtMask_oppositeLiteral_le_two
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralDualAggregation.abs_structuredActualRankOppositeLiteralBulkDualSum_le_two
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralCrossFormSkew.oppositeLiteralFixedDualCrossForm_skew_of_mem
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralCrossFormSkew.oppositeLiteralFixedDualCrossForm_self_eq_zero_of_mem
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralBoundaryLayer.offCoordinate_newlyHigh_min_card_eq
#check Frontier.OneTapeMagnification.FiniteBooleanOppositeLiteralBoundaryLayer.structuredDual_offCoordinate_newlyHigh_boundary_split
#check Frontier.OneTapeMagnification.FiniteStructuredDualCoefficientEndpoint.structuredGenerator_finiteAverage_eq_sum_dualCoefficients
#check Frontier.OneTapeMagnification.FiniteStructuredDualCoefficientEndpoint.nonemptyStructuredDualCoefficientSum_eq_sub_finiteAverage
#check Frontier.OneTapeMagnification.FiniteStructuredDualCoefficientEndpoint.nonemptyStructuredDualCoefficientSum_le_one
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorGlobalRankAlias.structuredRankWeightedDualFarPairCorrelation_eq_endpoint_sub_remainder
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorGlobalRankAlias.structuredRankWeightedDualFarPairCorrelation_eq_bias_sub_remainder
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorGlobalRankAlias.structuredDualHighHighStrictRankTail_add_atMost_eq_endpoint_sub_low
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorGlobalRankAlias.structuredDualHighHighStrictRankTail_eq_endpoint_sub_low_sub_atMost
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorGlobalRankAlias.structuredRankWeightedDualFarPairCorrelation_le_base_sub_remainder
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorGlobalRankAlias.prefixedMandatoryCanonicalSelector_dualFarBound_iff_globalRankAbel
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorGlobalRankAlias.prefixedMandatoryCanonicalSelector_dualFarBound_of_globalRankAbelRemainder
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorGlobalRankAliasDispersion.prefixedMandatoryCanonicalSelector_rankWeightedDualFar_le_terminal_add_dispersion
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorGlobalRankAliasDispersion.prefixedMandatoryCanonicalSelector_globalRankAbelRemainder_ge
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorGlobalRankAliasDispersion.prefixedMandatoryCanonicalSelector_dualFarBound_of_weightedRankDispersion
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorGlobalRankAliasLCP.mandatorySelectorCanonicalExactLCPChargeAverageSum_eq_diagonal_add_dualFar
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorGlobalRankAliasLCP.structuredDualRankAbelRemainder_eq_endpoint_add_diagonal_sub_lcp
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorGlobalRankAliasLCP.le_structuredDualRankAbelRemainder_iff_lcpChargeSum_le
#check Frontier.OneTapeMagnification.MandatoryCanonicalSelectorGlobalRankAliasLCP.prefixedMandatoryCanonicalSelector_dualFarBound_iff_diagonalAwareLCPBudget
