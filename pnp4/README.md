...
phase — the next one down was blocked on a missing G2p-b first-arrival theorem, which Part A G3b has
since supplied in pnp3 without building that composition, no first arrival of the composed
