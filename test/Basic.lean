...
import Pnp2.CanonicalCircuit
import Pnp2.ComplexityClasses
import Pnp2.NPSeparation
import Pnp2.Entropy
import Pnp2.Collentropy
import Pnp2.LowSensitivityCover
import Pnp2.AccMcspSat
import Pnp2.Bound
import Pnp2.CoverNumeric
import Pnp2.LowSensitivity
import Pnp2.MergeLowSens
...
example {N Nδ : ℕ} (F : Family N)
    (h₂ : BoolFunc.H₂ F ≤ N - Nδ)
    (hn_pos : 0 < N) :
    CoverNumeric.minCoverSize F (h := N - Nδ) h₂ hn_pos
